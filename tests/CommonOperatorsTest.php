...
final class CommonOperatorsTest extends TestCase
{
    public function testNoEmptyOperator(): void
    {
        ...
        new Config\BinaryOperator('', static fn ($a, $b) => $a + $b, Config\BinaryPriority::ADD);
    }
    ...
    public function testNoForbiddenCharsOperator(): void
    {
        ...
        new Config\BinaryOperator('0 .', static fn ($a, $b) => $a + $b, Config\BinaryPriority::ADD);
    }
}
